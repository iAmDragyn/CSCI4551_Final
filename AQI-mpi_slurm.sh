...
#SBATCH --ntasks=24              ## -n corresponds to MPI ranks/ each rank is one task
#SBATCH --ntasks-per-node=12      ### Number of tasks to be launched per Node, default = 1
