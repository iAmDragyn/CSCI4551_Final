...
//         Run:  $ make
//                  or
//               $ g++ -O -fopenmp AQI-seq.cpp -o AQI-seq -std=c++11
//               $ sbatch AQI-seq_slurm.sh <lower_bound> <upper_bound> <error>
// ------------------------------------------------------------------
...
int main(int argc, char *argv[]) {
  ...
  // Runtime clock start
  float runtime = clock()/(double)CLOCKS_PER_SEC;
  ...
  cout << " •  Runtime: " << setiosflags(ios::fixed) << setprecision(4) << runtime << " seconds." << endl;
